  ...
  return (
    <section className="panel plot-pane panel-enter panel-enter-delay-2">
      ...
      <div className="plot-canvas">
        {plotPayload ? <PlotCanvas payload={plotPayload} spec={plotSpec} theme={theme} /> : <div className="plot-placeholder">等待绘图结果</div>}
      </div>

      <div className="plot-metrics">
        <div className="metric-box">
          <div className="metric-title">自动统计</div>
      ...
      <details className="thinking-box">
        ...
        {thinking?.length ? (
          ...
          <div className="thinking-empty">暂无执行轨迹。</div>
        )}
      </details>
    </section>
  );
